...
→ Stützpunkt/Vertex auswählen und auf neu Position schieben
...
→ um zu einer bereits vorhandenen Planungsversion zurück zu kehren muss diese einfach wieder in der Attributtabelle ausgewählt werden und die Tabelle gespeichert werden